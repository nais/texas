    ...
    pub fn mock(host: String, port: u16) -> Self {
        ...
        Self {
            ...
            azure_ad: Some(Provider {
                ...
                token_endpoint: format!("{url_base}/azuread/token"),
            }),
            token_x:Some( Provider {
                ...
                token_endpoint: format!("{url_base}/tokenx/token"),
            }),
        }
    }
}
