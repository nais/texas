    ...
    impl Config {
        pub fn mock(host: String, port: u16) -> Self {
            ...
            Self {
                ...
                maskinporten_jwks_uri: format!("{url_base}/maskinporten/jwks"),
                maskinporten_issuer: format!("{url_base}/maskinporten"),
                maskinporten_token_endpoint: format!("{url_base}/maskinporten/token"),
                ...
                azure_ad_jwks_uri: format!("{url_base}/azuread/jwks"),
                azure_ad_issuer: format!("{url_base}/azuread"),
                azure_ad_token_endpoint: format!("{url_base}/azuread/token"),
                ...
                token_x_jwks_uri: format!("{url_base}/tokenx/jwks"),
                token_x_issuer: format!("{url_base}/tokenx"),
                token_x_token_endpoint: format!("{url_base}/tokenx/token"),
            }
        }
